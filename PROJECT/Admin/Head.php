...
<body>
  ...
  <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="ManageProduct.php">Addproduct</a></li>
                <li class="nav-item"> <a class="nav-link" href="ManageStock.php">Stock</a></li>
                <li class="nav-item"> <a class="nav-link" href="Category.php">Category</a></li>
                <li class="nav-item"> <a class="nav-link" href="SubCategory.php">Subcategory</a></li>
                <li class="nav-item"> <a class="nav-link" href="ViewProductBooking.php">ProductBooking</a></li>
                <li class="nav-item"> <a class="nav-link" href="viewcomplaint.php">ViewComplaints</a></li>
                <li class="nav-item"> <a class="nav-link" href="Replaydcomplaints.php">ReplydComplaints</a></li>
              </ul>
            <!-- </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <li class="nav-item"> <a class="nav-link" href="Servicies.php">AddServices</a></li>
              <i class="menu-arrow"></i> -->
            </a>
            <!-- <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="ViewCustomerBooking.php">Booking</a></li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="ViewCustomerBooking.php"> ViewBooking</a></li>
          <li class="nav-item"> <a class="nav-link" href="ViewProductBooking.php">ProductBooking</a></li>
          <li class="nav-item"> <a class="nav-link" href="Servicies.php">AddServices</a></li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="ProductSalesReport.php">Product Sales Report</a></li>
          <li class="nav-item"> <a class="nav-link" href="UserReport.php">UserBooking Report</a></li>
          <!-- <li class="nav-item"> <a class="nav-link" href="Servicies.php">AddServices</a></li> -->
