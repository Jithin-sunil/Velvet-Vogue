    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_booking b inner join tbl_cart c on b.booking_id=c.booking_id inner join tbl_product p on p.product_id=c.product_id  inner join tbl_customerregistration u on u.customer_id=b.customer_id where true and booking_status > 0 and cart_status > 0";
			 
			 
			 
			 if(isset($_POST["btn_search"]))
			 {
				 $selQry = $selQry." and booking_datetime between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
			 }
				  ...
				  $rs = $con->query($selQry);
                   while($data = $rs->fetch_assoc()) 
				   {
					   ...
					   $amt = $data["product_price"] * $data["cart_quantity"];
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["booking_datetime"]; ?></td>
                 ...
                 <td align="center"><?php echo $data["cart_quantity"]; ?></td>
