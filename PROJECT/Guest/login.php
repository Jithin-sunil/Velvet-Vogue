...
<form class="form" method="post">
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input placeholder="Enter your Email" class="input" type="text" name="txt_email" >
      </div>
    ...
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input placeholder="Enter your Password" name="txt_pass" class="input" type="password">
      </div>
    ...
    <input type="submit" name="btn_submit" value="Sign In" class="button-submit">
    <p class="p"><a href="ForgotPass.php"><span class="span">ForgotPassword</span></a>
