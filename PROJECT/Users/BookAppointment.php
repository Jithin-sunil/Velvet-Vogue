...

{
	...
	$date=$_POST['txt_date'];
	$time=$_POST['txt_time'];
		  $insQry="insert into tbl_Servicebooking(service_id,servicebooking_fordate,customer_id,servicebooking_time,servicebooking_date)values('".$service."','".$date."','".$_SESSION['cid']."','".$time."',curdate())";	
		 if($con->query($insQry))
         {
